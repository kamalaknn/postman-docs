...
1. Log in to [BigPanda](https://a.bigpanda.io/login){:target="_blank"}. Head over to the Integrations section.
...
<ol start="3">
  <li>To generate the App Key, enter the name of the integration as anything you want.</li>
</ol>
